    ...
    switch (menuSelection)
    {
        ...
        case "2":
            ...
            while (anotherPet == "y" && petCount < maxPets)
            {
                ...
                // build the animal the ID number - for example C1,C2,D3 ( for Cat1, Cat2,Dog3)
                ...
                // To Do : loop for pet's physical description
                ...
                do
                {
                    Console.WriteLine("Enter a description of the pet's personality (likes or dislikes, tricks, energy levels)");
                    readResult = Console.ReadLine();
